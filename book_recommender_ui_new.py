...
if st.sidebar.button("Recommend Me"):
    ...
    with col1:
        ...
        st.text('Book Title: ' + book_result[0][0])
        st.text('Author Name: ' + book_result [0][1])  
    with col2:
        st.image(book_result[1][2])
        st.text('Book Title: ' + book_result[1][0])
        st.text('Author Name: ' + book_result[1][1])
    with col3:
        st.image(book_result[2][2])
        st.text('Book Title: ' + book_result[2][0])
        st.text('Author Name: ' + book_result[2][1])
    with col4:
        st.image(book_result[3][2])
        st.text('Book Title: ' + book_result[3][0])
        st.text('Author Name: ' + book_result[3][1])
    with col5:
        st.image(book_result[4][2])
        st.text('Book Title: ' + book_result[4][0])
        st.text('Author Name: ' + book_result[4][1])